...
<?php echo $__env->make('cookie-notice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="banner"><p class="mainHeading">Categories</p>
    ...
    <?php
        $count = 0;
    ?>
    <?php $__currentLoopData = $tag; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if($tager->TAG_ID === $Atag -> TAG_ID): ?>
    <?php if($Atag->ARTICLE_ID === $post->ARTICLE_ID): ?>
        <div class="col">
            <a href="<?php echo e(url('/article', $post->ARTICLE_ID)); ?>"><p class="postHeading"><?php echo e($post->TITLE); ?></p></a>
            <p class="postContent"><?php echo e(substr($post->CONTENT, 0, 200)); ?>...</p>
            <p class="postDetails">Date : <?php echo e($post->DATE_CREATED); ?> ||
...
</html><?php /**PATH C:\Users\Gareth\OneDrive - Blue Falcon IT\Desktop\cool-tech\resources\views/tag.blade.php ENDPATH**/ ?>